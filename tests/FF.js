...
test("XOR mixed", testIO(XOR, { layers: [2, { neurons: 10, activator: "relu" }, 1] }))
test("OR mixed", testIO(OR, { layers: [2, { neurons: 10, activator: "relu" }, 1] }))
test("AND mixed", testIO(AND, { layers: [2, { neurons: 10, activator: "relu" }, 1] }))
test("RAND mixed", testIO(RAND, { layers: [2, { neurons: 10, activator: "relu" }, 1] }))
